      ...
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className=''>
          <form action='https://getform.io/f/81b688c4-dc6f-45aa-bdb5-4c69a677d2d8' method='POST' className='flex flex-col w-full'>
            <input type='text' name='nama' placeholder='Masukkan nama anda' className='p-2 bg-transparent border-2 rounded-md text-gray-400 border-[#00D8FF] focus:outline-none my-2' />
            <input type='text' name='email' placeholder='Masukkan email anda' className='p-2 bg-transparent border-2 rounded-md text-gray-400 border-[#00D8FF] focus:outline-none my-2' />
